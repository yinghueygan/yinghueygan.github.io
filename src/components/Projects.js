...
const projects = [
  ...
  },
  {
    ...
    status: 'Completed',
    year: '2024',
    description: 'A fully custom portfolio website built for a freelance interior designer client, featuring a photo gallery of her projects, an about page with awards, a contact form, and a secure PHP admin panel for full content management.',
    highlights: [
      'Secure admin panel with PHP login/logout & credential management (add, edit, delete users)',
      'Portfolio gallery page displaying project photos with descriptions and details',
      'About page showcasing client\'s experience, background and design awards',
      'Contact page with form submission — built with HTML, CSS, JavaScript & PHP',
    ],
    tech: ['PHP', 'CSS3', 'JavaScript', 'HTML5', 'MySQL'],
    github: 'https://github.com/yinghueygan',
    color: '#f59e0b',
  },
  {
